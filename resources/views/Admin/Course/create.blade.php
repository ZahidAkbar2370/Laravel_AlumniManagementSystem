                                    ...
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form class="form-horizontal" method="post" action="{{ url('admin/save-course') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" name="course_name" class="form-control" placeholder="{{ __('Course Name') }}" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                     ...
                                                     <button type="submit" class="btn btn-primary float-left btn-inline mb-50">{{ __('Save Course') }}</button>
                                                </form>
